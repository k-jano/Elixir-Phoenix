defmodule PokerPotionWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PokerPotionWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/poker_potion_web/templates",
                        namespace: PokerPotionWeb
